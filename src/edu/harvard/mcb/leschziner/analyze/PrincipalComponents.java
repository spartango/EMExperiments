...
public class PrincipalComponents {
    ...
    public CvMat getEigenVector(int componentIndex) {
        CvMat eigenVector = CvMat.createHeader(1, eigenVectors.cols(),
    ...
    public IplImage getEigenImage(int componentIndex) {
        ...
        CvMat target = CvMat.create(particleSize, particleSize,
                                    opencv_core.CV_32FC1);
        ...
        IplImage image = IplImage.create(normalized.cols(), normalized.rows(),
